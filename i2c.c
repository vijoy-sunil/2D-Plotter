//THIS MODULE CONTAINS THE CODE FOR GENERAL I2C CONTROL SUCH AS START,STOP ETC.,
//AUTHOR(S): VIJOY SUNIL KUMAR, PRAVEEN GNANASEKARN,I2C IMPLEMENTATION ON 8051 http://www.8051projects.net/wiki/I2C_Implementation_on_8051
#include "system.h"
