//THIS MODULE CONTAINS THE CODE FOR CONTROLLING STEPPER MOTOR TO MOVE PLOTTER IN SPECIFIC DIRECTIONS
...
void move_left(unsigned int l)	//50 % PWM DUTY CYCLE IS USED FOR ALL THE FUNCTIONS BELOW
{
    EN1 = 0;
    EN2 = 0;
...
void top_down_right(float new_steps)		// TO DRAW ARCS OF SPECCIFIC CIRCUMFERENCE AS INPUT BY THE USER
{
