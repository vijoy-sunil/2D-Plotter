//THIS MODULE CONTAINS THE CODE LCD MENU DISPLAY SCREEN AND ITS FUNCTIONALITY
...
void origin_menu_1_1(void)              //origin setting menu option- TO MOVE PLOTTER TO DESIRED POISITON 
{
    in_origin = 1;
    lcd_screen_2_1();
    cursor_x = 0;
